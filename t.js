...
const formFormatter = (menuName) => {
  if (menuName === "member") {
    ...
    inputUsername.placeholder = "Nom d'utilisateur";
    ...
    inputUsername.placeholder = "Entrez votre code ici";
    loginButton.style.display = "block";
    qrCodeInfo.style.display = "none";
...
toggleShowPassword.addEventListener("click", () => {
  ...
  if (inputPassword.type === "text") {
    ...
    toggleShowPasswordText.innerHTML = "Afficher";
  } else {
    inputPassword.type = "text";
    toggleShowPasswordText.innerHTML = "Masquer";
  }
});
